...
const T = {
	...
	panos_otsikko: { fi: 'Valitse panos', en: 'Choose a stake' },
	panos_rivi: { fi: '%s demokrediittiä', en: '%s demo credits' },
	panos_komissio: {
		fi: 'Talo ei ole ottelun osapuoli. Molemmat asettavat saman panoksen, voittaja saa potin ja talo perii siitä %s prosentin komission. Tasapelissä panokset palautetaan kokonaan eikä komissiota peritä.',
		en: 'The house is never a party to the match. Both players post the same stake, the winner takes the pot and the house charges a %s per cent commission on it. On a draw the stakes are returned in full and no commission is charged.',
	},
	jono_etsitaan: { fi: 'Etsitään vastustajaa', en: 'Looking for an opponent' },
	jono_peru: { fi: 'Peru haku', en: 'Cancel' },
	yhteys_katkesi: { fi: 'Yhteys ottelupalvelimeen katkesi.', en: 'The connection to the match server was lost.' },
	tilitys: {
		fi: 'Potti %s, komissio %s, sinulle %s',
		en: 'Pot %s, commission %s, to you %s',
	},
